...
function showWeatherInfo(jsonText) {
    ...
    document.getElementById("divOutput").innerHTML = weather.weather[0].description + "<br>" + "Temperature (°): " + weather.main.temp + "<br>" + "Wind (m/s): " + weather.wind.speed + "<br>" + "Cloud(%): " + weather.clouds.all;
}
fetchWeatherInfo();
// End